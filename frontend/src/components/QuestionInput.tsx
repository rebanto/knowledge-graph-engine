...
export function QuestionInput({
  ...
  return (
    <form onSubmit={handleSubmit} className="group relative w-full">
      ...
      <div className="pointer-events-none absolute -inset-px rounded-2xl opacity-0 transition-opacity duration-300 group-focus-within:opacity-100 glow-brass" />
      <input
        value={value}
        autoFocus={autoFocus}
      ...
      <button
        ...
        className={`absolute top-1/2 flex -translate-y-1/2 items-center justify-center rounded-xl bg-brass text-ink-900 transition-all duration-200 ease-spring disabled:opacity-30 enabled:hover:bg-brass-bright enabled:hover:glow-brass-soft ${
